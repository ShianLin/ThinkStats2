...
def ReadFemResp(dct_file='2002FemResp.dct',#./code/
                dat_file='2002FemResp.dat.gz',#E://GitHub/ThinkStats2/
                nrows=None):
...
def ReadFemPreg(dct_file='2002FemPreg.dct',#code/
                dat_file='2002FemPreg.dat.gz'):#code/
